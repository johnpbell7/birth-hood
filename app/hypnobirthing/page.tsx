...
const serviceSchema = {
  ...
  name: 'Hypnobirthing & Birth Preparation Courses',
  description: 'Evidence-based hypnobirthing and birth preparation courses in Leicester and online across the UK — releasing fear and building calm, confident birth preparation.',
