...
// Tier headers are all brand pink (#fe7fcc), stepping from a light tint up to
// the full colour so the progression reads without leaving the palette.
// Black type throughout — every tint is light.
const PACKAGES = [
